<template>
    <div
        class="fixed z-50 w-[90%] h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600"
    >
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            >
                <svg
                    ...
                    "
                    class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary dark:group-hover:text-primary"
                    aria-hidden="true"
            ...
            <div class="flex items-center justify-center">
                <RouterLink
                    to="/fuel-sold/create"
                    class="inline-flex items-center justify-center w-10 h-10 font-medium bg-primary rounded-full hover:bg-primary group focus:ring-4 focus:ring-primary focus:outline-none dark:focus:ring-primary"
                >
                    <svg
            ...
            >
                <svg
                    class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary transition-colors"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 20"
