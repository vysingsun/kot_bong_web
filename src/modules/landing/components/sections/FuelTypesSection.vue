<template>
    <section class="py-24 bg-white dark:bg-gray-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Custom types note -->
            <div
                class="mt-8 flex items-center justify-center gap-3 p-4 rounded-2xl bg-landing-primary-50 dark:bg-landing-primary-900/20 border border-landing-primary-200 dark:border-landing-primary-800"
            >
                <div
                    class="w-8 h-8 rounded-xl bg-landing-primary-100 dark:bg-landing-primary-800/50 flex items-center justify-center flex-shrink-0"
                >
