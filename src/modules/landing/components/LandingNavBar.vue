        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <router-link to="/" class="flex items-center gap-2.5 group">
                    <div
                        class="w-9 h-9 flex items-center justify-center rounded-xl bg-white shadow-lg shadow-landing-primary-600/40 group-hover:shadow-landing-primary-600/60 transition-all"
                    >
                        <svg
                            aria-hidden="true"
                            fill="blue"
