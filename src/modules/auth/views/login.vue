...
<template>
    <section class="bg-gray-50 dark:bg-gray-900 min-h-screen relative">
        <!-- Language Switcher - Top Right -->
        <div class="absolute top-6 right-6 z-10">
            <LanguageSwitcher />
        </div>

        <div class="flex items-center justify-center min-h-screen px-4 py-safe-top pb-safe-bottom">
            <div class="flex flex-col items-center w-full max-w-sm mx-auto py-16">
                <!-- Logo -->
                <img class="w-40 sm:w-48 md:w-56 mb-8" src="@/assets/images/base-station-blue.svg" alt="logo" />
                ...
                <div class="w-full space-y-4">
                    ...
                    <!-- Policy Link -->
                    <p class="text-xs text-center text-gray-400 dark:text-gray-500 pb-4">
