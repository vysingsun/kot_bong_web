        ...
        >
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <img :src="logo_img" class="h-9" alt="Tela Logo" />
                </div>
                <div class="flex items-center lg:order-2">
                    ...
                    >
                        ...
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                            <li @click="showModal">
                                <button
                                    class="w-100 block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                >
                                    Sign out
                                </button>
                            </li>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <a href="#" class="block p-4 text-center rounded-lg bg-gray-100 dark:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm text-gray-900 dark:text-white">Coefficients</div>
                    </a>
                    <button
                        class="block p-4 text-center rounded-lg bg-gray-100 dark:hover:bg-gray-600 group"
                        @click="showModal"
